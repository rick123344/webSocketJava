 ...
 * Generated at: 2017-03-02 10:49:50 UTC
...
return;
	...
	out.print(basePath);*/
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$scope.public = \"\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$scope.encry_data = \"\";\r\n");
      out.write("\t\t$scope.decry_data = \"\";\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t$scope.sender = {mail:\"\",content:\"\",name:\"\",result:\"\"};\r\n");
      out.write("\t\t\t$(\"#sendmail\").modal('show');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$scope.do_mail = function(){\r\n");
      out.write("\t\t\t//console.log($scope.myForm.$valid);\r\n");
      out.write("\t\t\t//console.log($scope.myForm.email.$valid);\r\n");
      out.write("\t\t\tif($scope.myForm.$valid){\r\n");
      out.write("\t\t\t\tif(confirm(\"Sure send a mail to author?\")){\r\n");
      out.write("\t\t\t\t\t$http({\r\n");
      out.write("\t\t\t\t\t\tmethod:'POST',\r\n");
      out.write("\t\t\t\t\t\turl:$location.absUrl(),\r\n");
      out.write("\t\t\t\t\t\tdata:$.param({key:\"mail\",key2:$scope.sender.mail,key3:$scope.sender.content,key4:$scope.sender.name}),\r\n");
      out.write("\t\t\t\t\t\theaders: {'Content-Type': 'application/x-www-form-urlencoded'}\r\n");
      out.write("\t\t\t\t\t}).then(function success(msg){\r\n");
      out.write("\t\t\t\t\t\tconsole.log(msg);\r\n");
      out.write("\t\t\t\t\t\tif(msg.data == \"Success\"){\r\n");
      out.write("\t\t\t\t\t\t\t$scope.sender.result = \"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:blue;'>Success Sended</b>\";\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t$scope.sender.result = \"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style='color:red;'>Fail ... </b>\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t},function error(err){\r\n");
      out.write("\t\t\t\t\t\tconsole.log(err);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$scope.doEncry = function(){\r\n");
      out.write("\t\t\t//console.log($scope.encry);\r\n");
      out.write("\t\t\t$http({\r\n");
      out.write("\t\t\t\tmethod:'POST',\r\n");
      out.write("\t\t\t\turl:$location.absUrl(),\r\n");
      out.write("\t\t\t\tdata:$.param({key:\"encrypt\",key2:$scope.encry}),\r\n");
      out.write("\t\t\t\theaders: {'Content-Type': 'application/x-www-form-urlencoded'}\r\n");
      out.write("\t\t\t}).then(function success(msg){\r\n");
      out.write("\t\t\t\t$scope.encry_data = msg.data;\r\n");
      out.write("\t\t\t\t$scope.decry = msg.data;\r\n");
      out.write("\t\t\t},function error(err){\r\n");
      out.write("\t\t\t\tconsole.log(err);\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$scope.doDecry = function(){\r\n");
      out.write("\t\t\t//console.log($scope.decry);\r\n");
      out.write("\t\t\t$http({\r\n");
      out.write("\t\t\t\tmethod:'POST',\r\n");
      out.write("\t\t\t\turl:$location.absUrl(),\r\n");
      out.write("\t\t\t\tdata:$.param({key:\"decrypt\",key2:$scope.decry}),\r\n");
      out.write("\t\t\t\theaders: {'Content-Type': 'application/x-www-form-urlencoded'}\r\n");
      out.write("\t\t\t}).then(function success(msg){\r\n");
      out.write("\t\t\t\t$scope.decry_data = msg.data;\r\n");
      out.write("\t\t\t},function error(err){\r\n");
      out.write("\t\t\t\tconsole.log(err);\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("\t\t\t\t<br> <b><large>RSA Demo (put some text in Encrypt textarea, then click Encrypt button): </large></b><br>\r\n");
      out.write("\t\t\t\t<div class='row break'>\r\n");
      out.write("\t\t\t\t\t<div class='col-md-6'>\r\n");
      out.write("\t\t\t\t\t\t<b>Encrypt :</b><br>\r\n");
      out.write("\t\t\t\t\t\t<textarea ng-model='encry' class='form-control'></textarea>\r\n");
      out.write("\t\t\t\t\t\t<input type='button' class='btn' ng-click=\"doEncry()\" value='Encrypt'/>\r\n");
      out.write("\t\t\t\t\t\t<div>{{encry_data}}</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class='col-md-6'>\r\n");
      out.write("\t\t\t\t\t\t<b>Decrypt :</b><br>\r\n");
      out.write("\t\t\t\t\t\t<textarea ng-model='decry' class='form-control'></textarea>\r\n");
      out.write("\t\t\t\t\t\t<input type='button' class='btn' ng-click=\"doDecry()\" value='Decrypt'/>\r\n");
      out.write("\t\t\t\t\t\t<div>{{decry_data}}</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<br><hr><br>\r\n");
      out.write("\t\t\t\t<br> <b><large>RSA Keys: </large></b><br>\r\n");
      out.write("\t\t\t\t<div class='row break'>\r\n");
      out.write("\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t<div class='col-md-4'>\r\n");
      out.write("\t\t\t\t\t\t<b>Public Key:</b><br>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<b>Private Key:</b><br>\r\n");
      out.write("\t\t\t\t\t\t");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pv}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<br>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"modal fade\" id=\"sendmail\" tabindex=\"-1\" role=\"dialog\" style=\"\" aria-labelledby=\"myModalLabel\">\r\n");
      out.write("\t\t\t\t<div class=\"modal-dialog\" role=\"document\">\r\n");
      out.write("\t\t\t\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"modal-header\">\r\n");
      out.write("\t\t\t\t\t\t\t<h4 class=\"modal-title\" id=\"myModalLabel\">Mail Sender (to author) <b compile='sender.result'></b></h4>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"modal-body\">\r\n");
      out.write("\t\t\t\t\t\t\t<form name='myForm'>\r\n");
      out.write("\t\t\t\t\t\t\t<div class='row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-3'>Your Name</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-6'><input type='text' class='form-control' name='name' placeholder='name...' ng-model='sender.name' required></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<div class='row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-3'>Your Mail</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-6'><input class='form-control' name='email' type='email' placeholder='email...' ng-model='sender.mail' required></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<div class='row'>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-3'>Content</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class='col-md-6'><textarea class='form-control' name='content' placeholder='content...' ng-model='sender.content' required></textarea></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<button type='submit' ng-click=\"do_mail()\" class='btn pull-right'>Send</button>\r\n");
      out.write("\t\t\t\t\t\t\t<br><br>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
