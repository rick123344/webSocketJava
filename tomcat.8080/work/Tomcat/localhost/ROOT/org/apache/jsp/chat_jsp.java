 ...
 * Generated at: 2017-03-03 03:17:55 UTC
...
return;
    ...
    try {
      ...
      out.write("/public/js/jsencrypt.min.js\"></script>\r\n");
      out.write("<style>\r\n");
      out.write("#main{\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$scope.publicKey = \"\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$scope.allmsg=[];\r\n");
      out.write("\t\t$scope.newmsg = \"\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//$scope.encrypt = new JSEncrypt();\r\n");
      out.write("\t\t$scope.decrypt = new JSEncrypt();\r\n");
      out.write("\t\t$scope.decrypt.setPublicKey($scope.publicKey);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\tvar tmp = JSON.parse(message.data);\r\n");
      out.write("\t\t\t$scope.allmsg.push(tmp.msg);\r\n");
